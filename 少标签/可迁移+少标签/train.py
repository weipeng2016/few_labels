...
def argsparser():
    ...
    parser.add_argument('--train', help='Training datasets', default='0+1+2+3+4+5+6+7+8_0.02_50')
    parser.add_argument('--test', help='Testing datasets', default='0+1+2+3+4+5+6+7+8_0.02_50')
...
def train(args):
    nums_das = [10, 50, 100, 200, 500, 1000]  # 少标签数目
    for nums_da in nums_das:
        ...
        train_datasets = ["train_nb_"+str(nums_da)]
        ...
        model.save(os.path.join(args.log, 'nb_da_%s_steps_%s'%(str(nums_da), str(args.num_timesteps))))
