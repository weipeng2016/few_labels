...
def argsparser():
    ...
    parser.add_argument('--test', help='Testing datasets', default='test_kdd')
    parser.add_argument('--budget', help='Budget in testing', type=int, default=200)
...
def evaluate(args):
    ...
    for d in eval_envs:
        ...
        print("reward", reward, "res", results[-1])
